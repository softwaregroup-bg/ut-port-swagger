...
* **ALZDFA1-449:** possibility to define public methods ([58cf94f](https://github.com/softwaregroup-bg/ut-port-swagger/commit/58cf94f))
...
* make use of default values in json schemas ([a89b8cf](https://github.com/softwaregroup-bg/ut-port-swagger/commit/a89b8cf))
...
* set swaggerDocument as an instance property in swagger port class ([e44f5b9](https://github.com/softwaregroup-bg/ut-port-swagger/commit/e44f5b9))



<a name="1.3.2"></a>
## [1.3.2](https://github.com/softwaregroup-bg/ut-port-swagger/compare/v1.3.1...v1.3.2) (2018-07-25)


### Bug Fixes

* edge cases and optimize code ([bd9eb77](https://github.com/softwaregroup-bg/ut-port-swagger/commit/bd9eb77))
